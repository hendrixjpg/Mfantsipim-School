    ...
    >
      <div className={cn(
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
          ...
          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-3">{leader.house}</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight mb-4">
            Prefectorial Hierarchy
          </h2>
          <p className="text-gray-500 text-sm font-bold uppercase tracking-widest">The leadership structure of Kwabotwe Hill</p>
        ...
        <div className="space-y-20">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-sm">
              <div className="text-center mb-6">
                <span className="text-[10px] text-red-500 font-black uppercase tracking-[0.3em]">Tier I: Executive</span>
              </div>
          ...
          <div>
            <div className="text-center mb-10">
              <span className="text-[10px] text-red-500 font-black uppercase tracking-[0.3em]">Tier II: Assistants</span>
            </div>
          ...
          <div>
            <div className="text-center mb-10">
              <span className="text-[10px] text-red-500 font-black uppercase tracking-[0.3em]">Tier III: Protocol</span>
            </div>
        ...
        >
          ...
          <button className="px-8 py-4 border-2 border-white/10 hover:border-red-600 text-gray-400 hover:text-white font-black uppercase tracking-widest rounded-full transition-all text-sm">
